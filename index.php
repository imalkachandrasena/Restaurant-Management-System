...
?>
                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            <h1 class="display-3 text-user animated slideInLeft">Taste Our<br>Delicious Meal</h1>
                            <p class="text-light animated slideInLeft mb-4 pb-2">Welcome to RestTaste, where culinary excellence meets a warm atmosphere. Our talented chefs create delicious dishes using the freshest ingredients, celebrating flavors from around the world. Whether you're here for a casual meal or a special occasion, we promise an unforgettable dining experience. Join us and savor the taste of exceptional cuisine!</p>
                        ...
                        <div class="col-lg-6 text-center text-lg-end overflow-hidden">
                            <img class="img-fluid" src="img/dish.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Master Chefs</h5>
                                <p>Our team of experienced and innovative chefs bring their culinary expertise to create exceptional dishes that delight your taste buds.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Quality Food</h5>
                                <p>We are using the highest-quality ingredients to ensure that every dish served at RestTaste is of the highest standard.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Online Order</h5>
                                <p>For your convenience, you can easily order your favorite dishes online and have them delivered straight to your doorstep.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>24/7 Service</h5>
                                <p>We are dedicated to providing you with exceptional service around the clock, ensuring that you can enjoy a delightful dining experience at any time.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">Welcome to <img src="<?php echo APPURL?>/img/favicon.png" alt="Logo"></i>RestTaste</h1>
                        <p class="mb-4">Welcome to RestTaste, where culinary excellence meets a warm and inviting atmosphere. Our restaurant is dedicated to providing a unique dining experience that celebrates the rich flavors and diverse cuisines from around the world. Whether you're here for a casual meal or a special occasion, our talented chefs craft each dish with the freshest ingredients and a passion for flavor.</p>
                        <p class="mb-4">At RestTaste, we believe that every meal should be memorable, and our attentive staff is committed to ensuring your visit is nothing short of exceptional. Join us and indulge in a delightful culinary journey that will tantalize your taste buds and leave you craving more!
        ...
        <div class="container-xxl py-5 px-0 wow fadeInUp" data-wow-delay="0.1s">
            <div class="row g-0">
                <div class="col-md-6">
                    <div class="video">
                        <button type="button" class="btn-play" data-bs-toggle="modal" data-src="https://www.youtube.com/embed/WW0SLuX8HsI?si=BN89TCxhU5IXe-Iu" data-bs-target="#videoModal">
                            <span></span>
                        </button>
                    </div>
                </div>
