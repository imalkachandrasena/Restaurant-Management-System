<?php 
  ...
  $app = new App;
  $app->startingSessionAdmin();

  define("ADMINURL", "http://localhost/resttaste/admin-panel");
...
<head>
    <meta charset="utf-8">
    <title>RestTaste - Admin Panel</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link href="http://localhost/resttaste/img/favicon.png" rel="icon">
...
<div id="wrapper">
    <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
      <div class="container">
      <a class="navbar-brand" href="#">RestTaste Restaurant - Admin Panel</a>
