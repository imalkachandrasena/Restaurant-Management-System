            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>123 Street,Gampaha,Sri Lanka</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p>Enter your email address and be connected with us.</p>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            <a class="border-bottom" href="#">RestTaste Restaurant - We Provide Your Taste. </a>  , All Right Reserved.
							<br>Designed By <a class="border-bottom" href="#">Imalka Chandrasena</a><br><br>
                        </div>
