                ...
                <div class="container text-center my-5 pt-5 pb-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item"><a href="#">Add to Cart</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center border-start border-5 border-primary px-3">
                                    <h3>Price: Rs. <?php echo $one->price; ?> </h3>
                                </div>
                            </div>
                        </div>
                        <form method="POST" action="add-cart.php?id=<?php echo $id; ?>">
                            ...
                            <?php if(isset($_SESSION['user_id'])) : ?>
                                ...
                                <?php endif; ?>
                            <?php else : ?>
                                <a class="btn btn-danger text-white" href="../auth/login.php">Please Login first</a>
                            <?php endif; ?>
                        </form>    
                    </div>
                </div>
